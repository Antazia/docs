---
title: Introduction
description: 'Welcome to the documentation of Scalechat.io'
---
...
<CardGroup cols={2}>
  <Card
    title="Create your first chatbot on Scalechat"
    icon="pen-to-square"
    href="https://scalechat.io/"
  >
    Train your chatbot / searchbot on your own data.
  </Card>
  <Card
